...
import browShapingBeforeAfterWebp from "../../assets/gallery/brow-shaping-before-after.webp";

// Row 1: Eyebrow - Eyebrow - Nails
...
const IMAGES: { src: string; alt: string }[] = [
  ...
  { src: browShapingBeforeAfterWebp, alt: "Eyebrow shaping before and after at Kaaya" },
